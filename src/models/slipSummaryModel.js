...
export const getSlipSummaryByBuHorizontalModels = (year, bu_code) => {
  const SQLQuery = `SELECT TOP (9)
                        bu_code,
                        bu_name,
                        partName,
                        partNumber,
...
export const getSummaryPriceByBUModels = (year, bu_code) => {
  const SQLQuery = `SELECT TOP (1000)
                        bu_code,
                        bu_name,
                        SUM(total_price) AS Total_Price
...
export const gerStakedBarModels = (year, bu_code) => {
  const SQLQuery = `SELECT
                        partName,
                        partNumber,
                        CASE WHEN B.[1] IS NULL THEN 0 ELSE B.[1] END AS January,
